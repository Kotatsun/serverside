...
<img src="https://aismiley.co.jp/wp-content/uploads/2021/11/rnn-method-1024x269.png" width="60%">
...
RNN、CNNの代わりに、Self-Attentionを使用し各単語の類似度を計算する  
→ **並列化可能！学習が高速に行える！**

### 1. Multi Head Attention
その文に出現する単語だけで内積をとり、単語間の類似度/関連度スコアを計算する（Self-Attention）  
→ **線形な処理**
